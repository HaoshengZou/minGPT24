...
class GPT(nn.Module):
    ...
    def __init__(self, config: ConfigNode, dummy_v=False):
        super().__init__()

        self.dummy_v = dummy_v
        ...
        if type_given:
            ...
            config.merge_from_dict({
                ...
                # (there are a number more for trying smaller gpt model ...)
        ...
        self.vf_head = nn.Linear(config.n_embd, 1)
